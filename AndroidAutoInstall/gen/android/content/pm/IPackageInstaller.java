 ...
 * Original file: D:\\work\\AndroidAutoInstall\\src\\android\\content\\pm\\IPackageInstaller.aidl
 */
...
static final int TRANSACTION_updateSessionAppIcon = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_updateSessionAppLabel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_abandonSession = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_openSession = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_getSessionInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_getAllSessions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_getMySessions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
...
static final int TRANSACTION_uninstall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_setPermissionsResult = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
}
//int createSession(in PackageInstaller.SessionParams params, String installerPackageName, int userId);
